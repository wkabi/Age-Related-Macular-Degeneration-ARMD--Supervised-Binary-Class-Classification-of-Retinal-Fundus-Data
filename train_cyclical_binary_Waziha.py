...
parser.add_argument('--csv_train', type=str, default='data/IRIS_AMD_train_MC_V2.csv', help='path to training data csv')
parser.add_argument('--data_path', type=str, default='data/cropped_images', help='path to training data cropped')
...
def train_model(model, optimizer, train_criterion, val_criterion, do_mixup, train_loader, val_loader,
	...
	## WAZIHA Modification
	# 1) build oversampled train loader
        val_loader_MOD = modify_dataset_bin(val_loader, csv_train_path=csv_val, keep_samples=oversample, see_classes=True)
