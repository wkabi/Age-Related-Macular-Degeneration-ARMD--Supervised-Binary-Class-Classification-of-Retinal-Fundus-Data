...
Modification date: March 1, 2023
'''
...
parser.add_argument('--data_path', type=str, default='data/cropped_images_9810/', help='path data')
parser.add_argument('--csv_val', type=str, default='data/IRIS_AMD_val_MC_V3.csv', help='path to val data csv')
parser.add_argument('--csv_test', type=str, default='data/IRIS_AMD_test_MC_V3_NOT_LABELED.csv', help='path to test data csv')
...
parser.add_argument('--csv_out_val', type=str, default='results_IRIS_AMD_val_MC_V1_resnet50.csv', help='path to output csv')
parser.add_argument('--csv_out_test', type=str, default='results_IRIS_AMD_test_MC_V1_resnet50.csv', help='path to output csv')
...
if __name__ == '__main__':
    ...
    if n_classes ==1 :
        ...
        im_list = [n.replace('/home/agaldran/DIAGNOSv2/data/cropped_images/','') for n in im_list]
        df = pd.DataFrame(zip(im_list, probs, labels),
                          columns=['image_id', 'AMD', 'label'])
    ...
    if n_classes == 1:
        ...
        im_list = [n.replace('/home/agaldran/DIAGNOSv2/data/cropped_images/','') for n in im_list]
        df_nogt = pd.DataFrame(zip(im_list, probs), columns=['image_id', 'AMD'])
    else: sys.exit('Wrong number of classes when saving dataframe')
