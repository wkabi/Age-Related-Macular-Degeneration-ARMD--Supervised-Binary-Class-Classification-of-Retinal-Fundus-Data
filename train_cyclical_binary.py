...
parser.add_argument('--csv_train', type=str, default='data/IRIS_AMD_train_MC_V3.csv', help='path to training data csv')
parser.add_argument('--data_path', type=str, default='data/cropped_images_9810', help='path to training data cropped')
